...
if [ ! -f "$ROOT/public/index.html" ]; then
  echo "HATA: Bu klasörü campus-head-ball depo klasörünün içine kopyala."
...
PY
node --check "$ROOT/public/mobile.js" 2>/dev/null || true
printf '\nTAMAMLANDI — Mobil joystick, J/K butonları ve iPhone web-app desteği eklendi.\n'
